...
if (-not $Env:VIRTUAL_ENV_DISABLE_PROMPT) {
    ...
    function global:prompt {
        # Return the virtualenv prefix followed by the original prompt string.
        # Avoid using Write-Host to remain compatible with script analyzer rules.
        return "($_PYTHON_VENV_PROMPT_PREFIX) $(& _OLD_VIRTUAL_PROMPT)"
    }
